...
\begin{document}
    ...
    \begin{header}
        ...
        \textbf{1Resume Software Engineer Template}

        \vspace{0.3 cm}

        \normalsize
        \mbox{{\footnotesize\faMapMarker*}\hspace*{0.13cm}XXXXX}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{mailto:one1resume.app@gmail.com}{{\footnotesize\faEnvelope[regular]}\hspace*{0.13cm}one1resume.app@gmail.com}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{tel:XXX-XXX-XXXX}{{\footnotesize\faPhone*}\hspace*{0.13cm}XXX-XXX-XXXX}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{XXXXX}{{\footnotesize\faLink}\hspace*{0.13cm}XXXXXX}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{XXXXXX}{{\footnotesize\faLinkedinIn}\hspace*{0.13cm}XXXXXX}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://github.com/yourusername}{{\footnotesize\faGithub}\hspace*{0.13cm}XXXXX}}%
    \end{header}
    ...
    \section{Publications}
        ...
        \begin{samepage}
            \begin{twocolentry}{
                ...
                \mbox{Frodo Baggins}, \mbox{\textbf{\textit{1Resume Software Engineer Template}}}, \mbox{Samwise Gamgee}
                \vspace{0.10 cm}
...
def test_latex_conversion():
    # Test LaTeX document with some formatting
    latex_content = r"""\documentclass[10pt, letterpaper]{article}
...
\end{document}"""
    ...
    # Test the function through the emulator
    emulator_url = "http://localhost:5001/resume-1b055/us-central1/latex_to_pdf"
    response = requests.post(emulator_url, json={'latex': latex_content})
    
    print(f"Response status code: {response.status_code}")
    print(f"Response headers: {response.headers}")
    
    if response.status_code == 200:
        print("Converting successful, writing PDF...")
        ...
        try:
            ...
            print(f"Raw error data: {response.text}")
